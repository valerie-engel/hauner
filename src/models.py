...
class LinkPredictor(pl.LightningModule):
    def __init__(self, vocab_size, n_layers, in_channels, hidden_channels, out_channels, n_heads, dropout, residual, margin):
        super().__init__()
        self.save_hyperparameters()
        self.embedding = torch.nn.Embedding(vocab_size, in_channels)
        self.encoder = GAT(
            n_layers=n_layers, 
            in_channels=in_channels, 
